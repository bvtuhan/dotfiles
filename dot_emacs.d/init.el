...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-window adaptive-wrap apheleia cape cider clojure-ts-mode consult
                copilot corfu-terminal crdt dape diredfl dirvish
                doom-modeline edraw evil-collection evil-goggles
                evil-org evil-tex flycheck-eglot flycheck-posframe
                general hl-todo jinx lsp-mode marginalia orderless
                org-download org-fragtog org-noter pdf-tools rustic
                sly undo-fu undo-fu-session vertico vhdl-ext
